 ...
 if($Num_Rows>0){	   
      ...
      <?php } ?>
				<tr>
                    ...
                    <input type="checkbox" name="salt1" class="css_dis_main2" value="ลดการเติมน้ำปลาเพิ่ม" onClick="ask2(this.value)">&nbsp;&nbsp;ลดการเติมน้ำปลาเพิ่ม</div></td>
       				<td style="background-color:#CCFF99"><div class="css_rowd3">
       				 <input type="checkbox" name="fat1" id="fat1" class="css_dis_main3" value="ใช้น้ำมันพืชประกอบอาหาร" onclick="ask3(this.value)" >&nbsp;&nbsp;ใช้น้ำมันพืชประกอบอาหาร</div></td>
      			</tr>                <tr>
        			<td style="background-color:#FFEBCD"><div class="css_rowd1">
                    ...
                    <input type="checkbox" name="salt2" class="css_dis_main2" value="ใช้เกลือ น้ำปลา ซีอิ๊ว ซอสหอยนางรม ซอสถั่วเหลืองให้น้อย"onclick="ask2(this.value)">&nbsp;&nbsp;ใช้เกลือ น้ำปลา ซีอิ๊ว ซอสหอยนางรม ซอสถั่วเหลืองให้น้อย</div></td>
       				<td style="background-color:#CCFF99"><div class="css_rowd3">
       				  <input type="checkbox" name="fat2" class="css_dis_main3" value="ทานอกไก่ ปลา หมูสันใน" onclick="ask3(this.value)" >&nbsp;&nbsp;ทานอกไก่ ปลา หมูสันใน</div></td>
      			</tr>
				<tr>
        			<td style="background-color:#FFEBCD"><div class="css_rowd1">
                ...
                <tr>
        			<td style="background-color:#FF9999"><div class="css_rowd1">&nbsp;&nbsp;ระวัง</div></td>
       				<td style="background-color:#F0FFF0"><div class="css_row2">
       				  <input type="checkbox" name="salt6" class="css_dis2" value=" Xระวังไส้กรอก" onclick="ask2(this.value)" />
       				  &nbsp;&nbsp;ไส้กรอก</div></td>
       				<td style="background-color:#CCFF99"><div class="css_rowd3">
				...
				<tr>
                    ...
                    <input type="checkbox" name="sweet7" class="css_dis1" value=" Xระวังกาแฟทรีอินวัน" onclick="ask1(this.value)">&nbsp;&nbsp;กาแฟทรีอินวัน</div></td>
       				<td style="background-color:#F0FFF0"><div class="css_row2">
                    <input type="checkbox" name="salt7" class="css_dis2" value=" Xระวังเบคอน"onClick="ask2(this.value)">&nbsp;&nbsp;เบคอน</div></td>
       				<td style="background-color:#CCFF99"><div class="css_rowd3">
                ...
                <tr>
        			<td style="background-color:#FFFFCC"><div class="css_row">
                    <input type="checkbox" name="sweet8" class="css_dis1" value=" Xระวังน้ำอัดลม" onClick="ask1(this.value)">&nbsp;&nbsp;น้ำอัดลม</div></td>
       				<td style="background-color:#F0FFF0"><div class="css_row2">
                    <input type="checkbox" name="salt8" class="css_dis2" value=" Xระวังหมูยอ" onClick="ask2(this.value)">&nbsp;&nbsp;หมูยอ</div></td>
       				<td style="background-color:#FF9999"><div class="css_rowd3">&nbsp;&nbsp;ระวัง</div></td>
      			</tr>
                <tr>
        			<td style="background-color:#FFFFCC"><div class="css_row">
                    <input type="checkbox" name="sweet9" class="css_dis1" value=" Xระวังชาเขียว" onClick="ask1(this.value)">&nbsp;&nbsp;ชาเขียว</div></td>
       				<td style="background-color:#F0FFF0"><div class="css_row2">
                    <input type="checkbox" name="salt9" class="css_dis2" value=" Xระวังกุนเเชียง" onClick="ask2(this.value)">&nbsp;&nbsp;กุนเเชียง</div></td>
       				<td style="background-color:#FFE3EE"><div class="css_row3">
                    <input type="checkbox" name="fat9" class="css_dis3" value=" Xระวังกาแฟทรีอินวัน" onClick="ask3(this.value)">&nbsp;&nbsp;กาแฟทรีอินวัน</div></td>
      			</tr>
                <tr>
        			<td style="background-color:#FFFFCC"><div class="css_row">
                    <input type="checkbox" name="sweet10" class="css_dis1" value="เ Xระวังครื่องดื่มถุงใส่นมข้นหวาน" onClick="ask1(this.value)">&nbsp;&nbsp;เครื่องดื่มถุงใส่นมข้นหวาน</div></td>
       				<td style="background-color:#F0FFF0"><div class="css_row2">
                    <input type="checkbox" name="salt10" class="css_dis2" value=" Xระวังแหนม" onClick="ask2(this.value)">&nbsp;&nbsp;แหนม</div></td>
       				<td style="background-color:#FFE3EE"><div class="css_row3">
                    <input type="checkbox" name="fat10" class="css_dis3" value=" Xระวังน้ำอัดลม"onClick="ask3(this.value)">&nbsp;&nbsp;น้ำอัดลม</div></td>
      			</tr>
				<tr>
        			<td style="background-color:#FFFFCC"><div class="css_row">
                    <input type="checkbox" name="sweet11" class="css_dis1" value=" Xระวังนมเปรี้ยว" onClick="ask1(this.value)">&nbsp;&nbsp;นมเปรี้ยว</div></td>
       				<td style="background-color:#F0FFF0"><div class="css_row2">
                    <input type="checkbox" name="salt11" class="css_dis2" value=" Xระวังไข่เค็ม" onClick="ask2(this.value)">&nbsp;&nbsp;ไข่เค็ม</div></td>
       				<td style="background-color:#FFE3EE"><div class="css_row3">
                    <input type="checkbox" name="fat11" class="css_dis3" value=" Xระวังชาเขียว"onClick="ask3(this.value)">&nbsp;&nbsp;ชาเขียว</div></td>
      			</tr>
                <tr>
        			<td style="background-color:#FFFFCC"><div class="css_row">
                    <input type="checkbox" name="sweet12" class="css_dis1" value=" Xระวังขนมขบเคี้ยว" onClick="ask1(this.value)">&nbsp;&nbsp;ขนมขบเคี้ยว</div></td>
       				<td style="background-color:#F0FFF0"><div class="css_row2">
                    <input type="checkbox" name="salt12" class="css_dis2" value=" Xระวังปลาเค็ม" onClick="ask2(this.value)">&nbsp;&nbsp;ปลาเค็ม</div></td>
       				<td style="background-color:#FFE3EE"><div class="css_row3">
                    <input type="checkbox" name="fat12" class="css_dis3" value=" Xระวังเครื่องดื่มถุงใส่นมข้นหวาน" onClick="ask3(this.value)">&nbsp;&nbsp;เครื่องดื่มถุงใส่นมข้นหวาน</div></td>
      			</tr>
				<tr>
        			<td style="background-color:#FFFFCC"><div class="css_row">
                    <input type="checkbox" name="sweet13" class="css_dis1" value=" Xระวังเค้ก" onClick="ask1(this.value)">&nbsp;&nbsp;เค้ก</div></td>
       				<td style="background-color:#F0FFF0"><div class="css_row2">
                    <input type="checkbox" name="salt13" class="css_dis2" value=" Xระวังกะปิ" onClick="ask2(this.value)">&nbsp;&nbsp;กะปิ</div></td>
       				<td style="background-color:#FFE3EE"><div class="css_row3"><input type="checkbox" name="fat13" class="css_dis3" value=" Xระวังไข่เจียว,ไข่ดาว"onClick="ask3(this.value)" id="fat13">
       				&nbsp;&nbsp;ไข่เจียว/ไข่ดาว</div></td>
		  </tr>
                <tr>
        			<td style="background-color:#FFFFCC"><div class="css_row">
                    <input type="checkbox" name="sweet14" class="css_dis1" value=" Xระวังคุกกี้" onClick="ask1(this.value)">&nbsp;&nbsp;คุกกี้</div></td>
       				<td style="background-color:#F0FFF0"><div class="css_row2">
                    <input type="checkbox" name="salt14" class="css_dis2" value=" Xระวังปลาร้า" onClick="ask2(this.value)">&nbsp;&nbsp;ปลาร้า</div></td>
       				<td style="background-color:#FFE3EE"><div class="css_row3">
                    <input type="checkbox" name="fat14" class="css_dis3" value=" Xระวังส้กรอก" onClick="ask3(this.value)">&nbsp;&nbsp;ไส้กรอก</div></td>
      			</tr>                
				<tr>
        			<td style="background-color:#FFFFCC"><div class="css_row">
                    <input type="checkbox" name="sweet15" class="css_dis1" value=" Xระวังโดนัท" onClick="ask1(this.value)">&nbsp;&nbsp;โดนัท</div></td>
       				<td style="background-color:#F0FFF0"><div class="css_row2">
                    <input type="checkbox" name="salt15" class="css_dis2" value=" Xระวังแจ่ว" onClick="ask2(this.value)">&nbsp;&nbsp;แจ่ว</div></td>
       				<td style="background-color:#FFE3EE"><div class="css_row3">
                    <input type="checkbox" name="fat15" class="css_dis3" value=" Xระวังเบคอน" onClick="ask1(this.value)">&nbsp;&nbsp;เบคอน</div></td>
      			</tr>
                <tr>
        			<td style="background-color:#FFFFCC"><div class="css_row">
                    <input type="checkbox" name="sweet16" class="css_dis1" value=" Xระวังขนมหวานใส่กะทิ" onClick="ask1(this.value)">&nbsp;&nbsp;ขนมหวานใส่กะทิ</div></td>
       				<td style="background-color:#F0FFF0"><div class="css_row2">
                    <input type="checkbox" name="salt16" class="css_dis2" value=" Xระวังเฟรนช์ฟรายส์" onClick="ask2(this.value)">&nbsp;&nbsp;เฟรนช์ฟรายส์</div></td>
       				<td style="background-color:#FFE3EE"><div class="css_row3">
                    <input type="checkbox" name="fat16" class="css_dis3" value=" Xระวังหมูยอ" onClick="ask3(this.value)">&nbsp;&nbsp;หมูยอ</div></td>
      			</tr> 
				<tr>
        			<td style="background-color:#FFFFCC"><div class="css_row">
                    <input type="checkbox" name="sweet17" class="css_dis1" value=" Xระวังชานมไข่มุก"  onClick="ask1(this.value)">&nbsp;&nbsp;ชานมไข่มุก</div></td>
       				<td style="background-color:#F0FFF0"><div class="css_row2">
                    <input type="checkbox" name="salt17" class="css_dis2" value=" Xระวังแฮมเบอร์เกอร์"  onClick="ask2(this.value)">&nbsp;&nbsp;แฮมเบอร์เกอร์</div></td>
       				<td style="background-color:#FFE3EE"><div class="css_row3">
                    <input type="checkbox" name="fat17" class="css_dis3" value=" Xระวังกุนเชียง"  onClick="ask3(this.value)">&nbsp;&nbsp;กุนเชียง</div></td>
      			</tr>
                <tr>
        			<td style="background-color:#FFFFCC"><div class="css_row">
                    <input type="checkbox" name="sweet18" class="css_dis1" value=" Xระวังไอศครีม" onClick="ask1(this.value)">&nbsp;&nbsp;ไอศครีม</div></td>
       				<td style="background-color:#F0FFF0"><div class="css_row2">
                    <input type="checkbox" name="salt18" class="css_dis2" value=" Xระวังขนมขบเคี้ยว" onClick="ask2(this.value)">&nbsp;&nbsp;ขนมขบเคี้ยว</div></td>
       				<td style="background-color:#FFE3EE"><div class="css_row3">
                    <input type="checkbox" name="fat18" class="css_dis3" value=" Xระวังแหนม"  onClick="ask3(this.value)">&nbsp;&nbsp;แหนม</div></td>
      			</tr>                
				<tr>
        			<td style="background-color:#FFFFCC"><div class="css_row">
                    <input type="checkbox" name="sweet19" class="css_dis1" value=" Xระวังทองหยิบทองหยอด" onClick="ask1(this.value)">&nbsp;&nbsp;ทองหยิบทองหยอด</div></td>
       				<td style="background-color:#F0FFF0"><div class="css_row2">
                    <input type="checkbox" name="salt19" class="css_dis2" value=" Xระวังพาย ขนมปัง" onClick="ask2(this.value)">&nbsp;&nbsp;พาย ขนมปัง</div></td>
       				<td style="background-color:#FFE3EE"><div class="css_row3">
                    <input type="checkbox" name="fat19" class="css_dis3" value=" Xระวังปาท่องโก๋" onClick="ask3(this.value)">&nbsp;&nbsp;ปาท่องโก๋</div></td>
      			</tr>
                <tr>
        			<td style="background-color:#FFFFCC"><div class="css_row">
                    <input type="checkbox" name="sweet20" class="css_dis1" value=" Xระวังทุเรียน" onClick="ask1(this.value)">&nbsp;&nbsp;ทุเรียน</div></td>
       				<td style="background-color:#F0FFF0"><div class="css_row2">
                    <input type="checkbox" name="salt20" class="css_dis2" value=" Xระวังข้าวคลุกกะปิ" onClick="ask2(this.value)">&nbsp;&nbsp;ข้าวคลุกกะปิ</div></td>
       				<td style="background-color:#FFE3EE"><div class="css_row3">
                    <input type="checkbox" name="fat20" class="css_dis3" value=" Xระวังเนย มาการีน มายองเนส" onClick="ask3(this.value)">&nbsp;&nbsp;เนย มาการีน มายองเนส</div></td>
      			</tr>                
				<tr>
        			<td style="background-color:#FFFFCC"><div class="css_row">
                    <input type="checkbox" name="sweet21" class="css_dis1" value=" Xระวังแตงโม" onClick="ask1(this.value)">&nbsp;&nbsp;แตงโม</div></td>
       				<td style="background-color:#F0FFF0"><div class="css_row2">
                    <input type="checkbox" name="salt21" class="css_dis2" value=" Xระวังบะหมี่กึ่งสำเร็จรูป"  onClick="ask2(this.value)">&nbsp;&nbsp;บะหมี่กึ่งสำเร็จรูป</div></td>
       				<td style="background-color:#FFE3EE"><div class="css_row3">
                    <input type="checkbox" name="fat21" class="css_dis3" value=" Xระวังกล้วย,มัน,เผือกทอด" onClick="ask3(this.value)">&nbsp;&nbsp;กล้วย,มัน,เผือกทอด</div></td>
      			</tr>
                <tr>
        			<td style="background-color:#FFFFCC"><div class="css_row">
                    <input type="checkbox" name="sweet22" class="css_dis1" value=" Xระวังสับปะรด"  onClick="ask1(this.value)">&nbsp;&nbsp;สับปะรด</div></td>
       				<td style="background-color:#F0FFF0"><div class="css_row2">
                    <input type="checkbox" name="salt22" class="css_dis2" value=" Xระวังอาหารหมัก,ดอง"  onClick="ask2(this.value)">&nbsp;&nbsp;อาหารหมัก/ดอง</div></td>
       				<td style="background-color:#FFE3EE"><div class="css_row3">
                    <input type="checkbox" name="fat22" class="css_dis3" value=" Xระวังเฟรนช์ฟรายส์"  onClick="ask3(this.value)">&nbsp;&nbsp;เฟรนช์ฟรายส์</div></td>
      			</tr>                
				<tr>
        			<td style="background-color:#FFFFCC"><div class="css_row">
                    <input type="checkbox" name="sweet23" class="css_dis1" value=" Xระวังแก้วมังกร"  onClick="ask1(this.value)">&nbsp;&nbsp;แก้วมังกร</div></td>
       				<td style="background-color:#F0FFF0">                    </td>
       				<td style="background-color:#FFE3EE"><div class="css_row3">
                    <input type="checkbox" name="fat23" class="css_dis3" value=" Xระวังแฮมเบอร์เกอร์"  onClick="ask3(this.value)">&nbsp;&nbsp;แฮมเบอร์เกอร์</div></td>
      			</tr>
                <tr>
        			<td style="background-color:#FFFFCC"><div class="css_row">
                    <input type="checkbox" name="sweet24" class="css_dis1" value=" Xระวังลองกอง , ลำไย"  onClick="ask1(this.value)">&nbsp;&nbsp;ลองกอง , ลำไย</div></td>
       				<td style="background-color:#F0FFF0">                    </td>
       				<td style="background-color:#FFE3EE"><div class="css_row3">
                    <input type="checkbox" name="fat24" class="css_dis3" value=" Xระวังน้ำครีมสลัด"  onClick="ask3(this.value)">
                    &nbsp;น้ำครีมสลัดน้ำข้น</div></td>
      			</tr>                
 				<tr>
        			<td height="25" style="background-color:#FFFFCC"><div class="css_row">
                    <input type="checkbox" name="sweet25" class="css_dis1" value=" Xระวังองุ่น"  onClick="ask1(this.value)">&nbsp;&nbsp;องุ่น</div></td>
   				  <td style="background-color:#F0FFF0">                    </td>
       				<td style="background-color:#FFE3EE"><div class="css_row3">
                    <input type="checkbox" name="fat25" class="css_dis3" value=" Xระวังขนมขบเคี้ยว" onClick="ask3(this.value)">&nbsp;&nbsp;ขนมขบเคี้ยว</div></td>
      			</tr>
                <tr>
        			<td style="background-color:#FFFFCC">                    </td>
       				<td style="background-color:#F0FFF0">                    </td>
       				<td style="background-color:#FFE3EE"><div class="css_row3">
                    <input type="checkbox" name="fat26" class="css_dis3" value=" Xระวังเค้ก"onClick="ask3(this.value)">&nbsp;&nbsp;เค้ก</div></td>
      			</tr> 
				<tr>
        			<td style="background-color:#FFFFCC">                    </td>
       				<td style="background-color:#F0FFF0">                    </td>
       				<td style="background-color:#FFE3EE"><div class="css_row3">
                    <input type="checkbox" name="fat27" class="css_dis3" value=" Xระวังคุกกี้"onClick="ask3(this.value)">&nbsp;&nbsp;คุกกี้</div></td>
      			</tr>
                <tr>
        			<td style="background-color:#FFFFCC">                    </td>
       				<td style="background-color:#F0FFF0">                    </td>
       				<td style="background-color:#FFE3EE"><div class="css_row3">
                    <input type="checkbox" name="fat28" class="css_dis3" value="โ Xระวังดนัท"onClick="ask3(this.value)">&nbsp;&nbsp;โดนัท</div></td>
      			</tr>
				<tr>
        			<td style="background-color:#FFFFCC">                    </td>
       				<td style="background-color:#F0FFF0">                    </td>
       				<td style="background-color:#FFE3EE"><div class="css_row3">
                    <input type="checkbox" name="fat29" class="css_dis3" value=" Xระวังพาย"onClick="ask3(this.value)">&nbsp;&nbsp;พาย</div></td>
      			</tr>
                <tr>
        			<td style="background-color:#FFFFCC">                    </td>
       				<td style="background-color:#F0FFF0">                    </td>
       				<td style="background-color:#FFE3EE"><div class="css_row3"><input type="checkbox" name="fat30" class="css_dis3" value=" Xระวังข้าวขาหมู"onClick="ask3(this.value)" id="fat30">
       				&nbsp;&nbsp;ข้าวขาหมู</div></td>
      			</tr>                                              
				<tr>
        			<td style="background-color:#FFFFCC">                    </td>
       				<td style="background-color:#F0FFF0">                    </td>
       				<td style="background-color:#FFE3EE"><div class="css_row3">
                    <input type="checkbox" name="fat31" class="css_dis3" value=" Xระวังขนมหวานใส่กะทิ"onClick="ask3(this.value)">&nbsp;&nbsp;ขนมหวานใส่กะทิ</div></td>
      			</tr>
                <tr>
        			<td style="background-color:#FFFFCC">                    </td>
       				<td style="background-color:#F0FFF0">                    </td>
       				<td style="background-color:#FFE3EE"><div class="css_row3">
                    <input type="checkbox" name="fat32" class="css_dis3" value=" Xระวังชานมไข่มุก"onClick="ask3(this.value)">&nbsp;&nbsp;ชานมไข่มุก</div></td>
      			</tr>
				<tr>
        			<td style="background-color:#FFFFCC">                    </td>
       				<td style="background-color:#F0FFF0">                    </td>
       				<td style="background-color:#FFE3EE"><div class="css_row3">
                    <input type="checkbox" name="fat33" class="css_dis3" value=" Xระวังไอศครีม"onClick="ask3(this.value)">&nbsp;&nbsp;ไอศครีม</div></td>
      			</tr>
                <tr>
        			<td style="background-color:#FFFFCC">                    </td>
       				<td style="background-color:#F0FFF0">                    </td>
       				<td style="background-color:#FFE3EE"><div class="css_row3">
                    <input type="checkbox" name="fat34" class="css_dis3" value=" Xระวังทองหยิบทองหยอด"onClick="ask3(this.value)">&nbsp;&nbsp;ทองหยิบทองหยอด</div></td>
      			</tr>                
				<tr>
        			<td style="background-color:#FFFFCC">                    </td>
       				<td style="background-color:#F0FFF0">                    </td>
       				<td style="background-color:#FFE3EE"><div class="css_row3">
                    <input type="checkbox" name="fat35" class="css_dis3" value=" Xระวังข้าวคลุกกะปิ"onClick="ask3(this.value)" id="fat35">
                    &nbsp;&nbsp;ข้าวคลุกกะปิ</div></td>
      			</tr>
                <tr>
        			<td style="background-color:#FFFFCC">                    </td>
       				<td style="background-color:#F0FFF0">                    </td>
       				<td style="background-color:#FFE3EE"><div class="css_row3">
                    <input type="checkbox" name="fat36" class="css_dis3" value=" Xระวังอาหารทะเลที่ไม่ใช่ปลา"onClick="ask3(this.value)">&nbsp;&nbsp;อาหารทะเลที่ไม่ใช่ปลา</div></td>
      			</tr>
				<tr>
        			<td style="background-color:#FFFFCC">                    </td>
       				<td style="background-color:#F0FFF0">                    </td>
       				<td style="background-color:#FFE3EE"><div class="css_row3">
                    <input type="checkbox" name="fat37" class="css_dis3" value=" Xระวังแกงที่มีกะทิ"onClick="ask3(this.value)">&nbsp;&nbsp;แกงที่มีกะทิ</div></td>
      			</tr>
                <tr>
        			<td style="background-color:#FFFFCC">                    </td>
       				<td style="background-color:#F0FFF0">                    </td>
       				<td style="background-color:#FFE3EE"><div class="css_row3">
                    <input type="checkbox" name="fat38" class="css_dis3" value=" Xระวังข้าวมันไก่"onClick="ask3(this.value)">&nbsp;&nbsp;ข้าวมันไก่</div></td>
      			</tr>                
				<tr>
        			<td style="background-color:#FFFFCC">                    </td>
       				<td style="background-color:#F0FFF0">                    </td>
       				<td style="background-color:#FFE3EE"><div class="css_row3">
                    <input type="checkbox" name="fat39" class="css_dis3" value=" Xระวังหอยทอด ผัดไทย"onClick="ask3(this.value)">&nbsp;&nbsp;หอยทอด ผัดไทย</div></td>
      			</tr> 
		  </tbody>                
		</table>  
 ...
 if($Num_Rows>0){	   
      ...
      <?php } ?>
				<tr>
                    ...
                    &nbsp;&nbsp;วิ่ง</div></td>
       				<td style="background-color:#CCFFFF"><div class="css_rowd5">
                    <input type="checkbox" name="ex2_2"  id="ex2_2" class="css_dis_main5" value="สมาธิบำบัด (SKT)"onclick="ask5(this.value)">
                    &nbsp;&nbsp;สมาธิบำบัด (SKT)</div></td>
       				</tr>
				<tr>
        			<td style="background-color:#FFEBCD"><div class="css_rowd4">
        			  ...
        			  &nbsp;&nbsp;ว่ายน้ำ</div></td>
       				<td style="background-color:#CCFFFF"><div class="css_rowd5">
                    <input type="checkbox" name="ex2_2"  id="ex2_2" class="css_dis_main5" value="ไทเก็ก"onclick="ask5(this.value)">
                    &nbsp;&nbsp;ไทเก็ก</div></td>
   				</tr>
                <tr>
        			<td style="background-color:#FFEBCD"><div class="css_rowd4">
                    ...
                    &nbsp;&nbsp;แอโรบิค</div></td>
       				<td style="background-color:#CCFFFF"><div class="css_rowd5">
                    <input type="checkbox" name="ex2_2"  id="ex2_2" class="css_dis_main5" value="ชี่กง"onclick="ask5(this.value)">
                    &nbsp;&nbsp;ชี่กง</div></td>
   				</tr>
				<tr>
        			<td style="background-color:#FFEBCD"><div class="css_rowd4">
